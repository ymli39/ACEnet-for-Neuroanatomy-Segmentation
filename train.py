...
RESUME_PATH = './save_model/MALC_fine/checkpoint_pretrain.pth.tar' #directory you want to resume the model
SAVE_DIR = './save_model/demo/' #directory you want to save the model
NUM_CLASS = 139 #for MALC-coarse grained use 28, for MALC-fine grained use 139
